  ...
  try {
    ...
    if (options.installed_services != null) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        srv = ref[i];
        if (srv !== 'KERBEROS' && srv !== 'RANGER' && srv !== 'HDFS' && srv !== 'YARN' && srv !== 'HIVE' && srv !== 'HBASE' && srv !== 'SQOOP' && srv !== 'OOZIE' && srv !== 'PIG' && srv !== 'TEZ' && srv !== 'NIFI' && srv !== 'KAFKA' && srv !== 'MAPREDUCE2' && srv !== 'ZOOKEEPER' && srv !== 'SPARK' && srv !== 'SPARK2' && srv !== 'KNOX' && srv !== 'AMBARI_METRICS' && srv !== 'LOGSEARCH' && srv !== 'ATLAS' && srv !== 'ZEPPELIN') {

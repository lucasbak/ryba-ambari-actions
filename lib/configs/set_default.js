  ...
  try {
    ...
    if (options.installed_services != null) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        srv = ref[i];
        if (srv !== 'KERBEROS' && srv !== 'RANGER' && srv !== 'HDFS' && srv !== 'YARN' && srv !== 'HIVE' && srv !== 'HBASE' && srv !== 'SQOOP' && srv !== 'OOZIE' && srv !== 'PIG' && srv !== 'TEZ' && srv !== 'NIFI' && srv !== 'KAFKA' && srv !== 'MAPREDUCE2' && srv !== 'ZOOKEEPER' && srv !== 'SPARK' && srv !== 'SPARK2' && srv !== 'KNOX') {
      ...
      try {
        ...
        do_update_service_config = function(index, target_services) {
          ...
          do_update_service_config_type = function(index_config, configs) {
            ...
            if (config_type === "spark-defaults") {
              console.log('I DO UPDATE MOTHER FUCKER', config_type, options.properties);
            }
